...
latent_dim = 2  # You can change latent_dim for your use case
...
model = keras.Sequential([
    ...
    layers.Dropout(0.03),  # Dropout cơ bản, thường dùng 0.1
    layers.Dense(32, activation="relu", kernel_regularizer=keras.regularizers.l2(0.001)),
    layers.Dropout(0.02), # Dropout cơ bản, thường dùng 0.05
    layers.Dense(1)
])
...
sample = np.array([[399.929792167592, 84.52612622449081, 56.18025153633774, 69.97894198886914]])  # Best controllable settings
